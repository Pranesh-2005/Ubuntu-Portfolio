    ...
    return (
        <>
            ...
            <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>my name is <span className="font-bold">Pranesh</span> ,</div>
                <div className="font-normal ml-1">I'm a <span className="text-pink-600 font-bold">AIML Engineer</span></div>
            </div>
            ...
            <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                ...
                <li className=" mt-3 list-building"> I enjoy building AI Models and AI powered applications that solves Real world problems.</li>
                <li className=" mt-3 list-time"> When I am not coding my next project, I like to spend my time reading blogs-Technical one, playing football or watching YouTube videos.</li>
                <li className=" mt-3 list-star"> And I also have interest in Deep Learning & GenAI!</li>
            </ul>
        </>
    )
}
        ...
        <>
            ...
            <ul className=" w-10/12  mt-4 ml-4 px-0 md:px-1">
                <li className="list-disc">
                    ...
                    <div className="text-sm text-gray-300 font-bold mt-1">CGPA &nbsp; 7.81/10 upto 6<sup>th</sup> semester</div>
                </li>
                <li className="list-disc mt-5">
                    ...
                    <div className="text-sm text-gray-300 font-bold mt-1">Percentile Rank &nbsp; 89.8%</div>
                </li>
            </ul>
        </>
    )
    ...
    const project_list = [
        {
            ...
            description: [
                "Deepfake Detector a Open-source tool to spot fake images, videos & audio using EfficientNetV2 + MTCNN",
            ],
            domains: ["Python", "Gradio", "PyTorch", "Tensorflow","MTCNN","EffecientNetV2", "HuggingFace"]
        },
        {
            name: "Readme and License Generator",
            date: "Jul 2025",
            link: "https://github.com/pranesh-2005/githubreadmeandLicenseGenerator",
            description: [
                "Auto Generates Readme and License for your GitHub Repository in one click.",
            ],
            domains: ["Python", "Flask", "Azure Open AI", "HTML", "CSS", "JS"]
        },
        {
            name: "Text-Emotion",
            date: "Nov 2025",
            ...
            description: [
                "A Python package that lets you to detect emotions in text.",
            ],
            domains: ["python", "pypi", "toml", "RoBerta", "onnx"]
        },
        {
            name: "Nl2Sql2Nl",
            date: "Jun 2025",
            link: "https://github.com/pranesh-2005/s7-mini-project",
            description: [
                "A website that translates and Natural language quries into SQL and executes them and displays the output in Natural Language",
            ],
            domains: ["Python", "FastMCP", "Servlette", "CopilotKit", "NextJs"]
        },
        {
            ...
            description: [
                "A Personal Portfolio that showcases my Biography, Skills, Project, Education and Certificates",
            ],
            domains: ["React", "GatsbyJs", "TailwindCSS", "GraphQL", "Js"]
        },
        {
            name: "GitHub Readme Stats Fast",
            date: "Sep 2025",
            link: "https://github.com/pranesh-2005/github-readme-stats-fast",
            description: [
                "A Fast version with 0 seconds cache of github-readme-stats with streak card added.",
            ],
...
function Resume() {
    return (
        <iframe className="h-full w-full" src="./files/Pranesh-Resume.pdf" title="Pranesh resume" frameBorder="0"></iframe>
    )
}